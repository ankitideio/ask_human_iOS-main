...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/DynamsoftCameraEnhancer/DynamsoftCameraEnhancer.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/DynamsoftCaptureVisionRouter/DynamsoftCaptureVisionRouter.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/DynamsoftCodeParser/DynamsoftCodeParser.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/DynamsoftCodeParserDedicator/DynamsoftCodeParserDedicator.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/DynamsoftCore/DynamsoftCore.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/DynamsoftImageProcessing/DynamsoftImageProcessing.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/DynamsoftLabelRecognizer/DynamsoftLabelRecognizer.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/DynamsoftLicense/DynamsoftLicense.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/DynamsoftMRZ/DynamsoftMRZ.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/DynamsoftMRZScannerBundle/DynamsoftMRZScannerBundle.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/DynamsoftNeuralNetwork/DynamsoftNeuralNetwork.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/DynamsoftUtility/DynamsoftUtility.framework"
