...
- (UIColor *)cameraPreviewBackgroundColorInCameraController:(RGLDocumentReaderCameraViewController *)controller;
...
- (NSTimeInterval)nextPageAnimationStartDelay:(RGLDocumentReaderCameraViewController *)controller;
- (NSTimeInterval)nextPageAnimationEndDelay:(RGLDocumentReaderCameraViewController *)controller;
...
- (BOOL)torchIsUsed:(RGLDocumentReaderCameraViewController *)controller;
...
- (nullable UIImage *)livenessAnimationImageInCameraController:(RGLDocumentReaderCameraViewController *)controller;
- (CGFloat)livenessAnimationPositionMultiplierInCameraController:(RGLDocumentReaderCameraViewController *)controller;
- (UIViewContentMode)livenessAnimationContentModeInCameraController:(RGLDocumentReaderCameraViewController *)controller;
