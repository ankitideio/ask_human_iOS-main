...
@IBDesignable open class RangeSlider: UIControl {
  ...
  @IBInspectable open var trackHighlightTintColor: UIColor = UIColor(red: 0.718, green: 0.047, blue: 0.557, alpha: 1.0) {
    didSet {
      track.setNeedsDisplay()
    }
  }
  ...
  @IBInspectable open var trackThickness: CGFloat = 0.2 {
    didSet {
      updateTrackLayerFrameAndKnobPositions()
    }
  }
