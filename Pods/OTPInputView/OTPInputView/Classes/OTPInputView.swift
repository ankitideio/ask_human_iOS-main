...
@IBDesignable public class OTPInputView: UIView {
    ...
    @IBInspectable var isDarkModeEnabled: Bool = false {
            didSet {
    ...
    fileprivate func updateAppearanceForMode() {
            ...
            for case let textField as OTPTextField in subviews where textField is OTPTextField {
    ...
    fileprivate func setupTextFieldStyle(_ textField: UITextField) {
        ...
        textField.layer.borderColor = UIColor(red: 222/255.0, green: 123/255.0, blue: 222/255.0, alpha: 1.0).cgColor
